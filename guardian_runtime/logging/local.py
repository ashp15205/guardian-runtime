...
from guardian_runtime.core.models import GuardianRuntimeResponse, Violation
from guardian_runtime.core.storage import GUARDIAN_RUNTIME_DIR

LOGS_DIR = GUARDIAN_RUNTIME_DIR / "logs"


class LocalLogger:
    """Appends structured events to ~/.guardian_runtime/logs/YYYY-MM-DD.jsonl."""
