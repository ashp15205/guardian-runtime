"""
GuardianRuntime Dashboard Server
===========================
Serves a local dark-mode web dashboard at http://localhost:3001

  GET /          → full HTML dashboard page
  GET /api/stats → aggregated stats from ~/.guardian_runtime/logs/
...
<head>
  ...
  <title>GuardianRuntime Dashboard</title>
...
<body>
  ...
  <main>
    ...
    <p class="subtitle" id="log-path">Reading from ~/.guardian_runtime/logs/ &nbsp;·&nbsp; auto-refreshes every 5s</p>
  ...
  <div class="footer">
    ...
    GuardianRuntime Runtime · Local-only · No data leaves your machine
  </div>
...
def create_dashboard_app() -> FastAPI:
    app = FastAPI(title="GuardianRuntime Dashboard", docs_url=None, redoc_url=None)
