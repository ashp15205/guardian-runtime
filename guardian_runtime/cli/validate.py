"""guardian_runtime validate — validate a YAML policy file."""

import click

from guardian_runtime.core.policy import PolicyValidationError, load_policy


@click.command("validate")
@click.argument("policy_file", type=click.Path(exists=True))
def validate_command(policy_file: str) -> None:
    """Validate a GuardianRuntime YAML policy file."""
    try:
